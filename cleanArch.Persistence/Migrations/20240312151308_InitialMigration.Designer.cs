...
namespace cleanArch.Persistence.Migrations
{
    ...
    [Migration("20240312151308_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cleanArch.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("cleanArch.Domain.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("cleanArch.Domain.Post", b =>
                {
                    b.HasOne("cleanArch.Domain.Category", "Category")
                        .WithMany("Blogs")
